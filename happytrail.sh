...
# pooltoy tx bank sendbob $(pooltoy keys show alice -a) 1🚀 --from bob -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx
# pooltoy tx bank sendyou $(pooltoy keys show me -a) 1token --from you -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx
# pooltoy tx bank sendme $(pooltoy keys show who -a) 1token --from me | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx
...
pooltoy tx bank send bob $(pooltoy keys show alice -a) 1🚀 --from bob -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx | jq ".raw_log"
...
# pooltoy tx bank sendalice $(pooltoy keys show bob -a) 1💸 --from alice -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx | jq ".raw_log"
# pooltoy tx bank sendbob $(pooltoy keys show carol -a) 1🚀 --from bob -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx | jq ".raw_log"
# pooltoy tx bank sendcarol $(pooltoy keys show alice -a) 1🌝 --from carol -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx | jq ".raw_log"
...
# echo "should fail"
# pooltoy tx bank sendalice $(pooltoy keys show doug -a) 1🌝 --from alice -y | jq ".txhash" |  xargs $(sleep 6) pooltoy q tx | jq ".raw_log"
